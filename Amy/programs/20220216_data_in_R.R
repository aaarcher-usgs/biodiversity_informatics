...
#' 
names(evens) <- c("Bob", "Jeff", "Dave", "Paul", "Greg")
class(names(evens)) #changed from numeric to character
...
#' 
#' spin this with:
#' ezspin(file = "Amy/programs/20220216_data_in_R.R",out_dir = "Amy/output", fig_dir = "figures",keep_md = FALSE, keep_rmd = FALSE)

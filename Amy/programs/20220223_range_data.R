...
#' Programmer: Amy
#' 
#' In this program, I learned how to make figures, ranges, and plots.
#' 
#' 
#' ### Header
#' 
...
#' 
alns.gaps <- gaps(alns)
names(alns.gaps) <- paste0(letters[1: length(alns.gaps)], "-reduce")
alns.gaps
...
#' 
#' spin this with:
#' ezspin(file = "Amy/programs/20220223_range_data.R",out_dir = "Amy/output", fig_dir = "figures20220223",keep_md = FALSE, keep_rmd = FALSE)

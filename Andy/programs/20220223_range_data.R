...
#' Programmer: Andy
#' 
#' In this program, we worked with range data to make and design figures.
#' 
#' 
#' ### Header
#' 
...
#' 
#' spin this with:
#' ezspin(file = "Andy/programs/20220223_range_data.R",out_dir = "Andy/output", fig_dir = "figures20220223",keep_md = FALSE, keep_rmd = FALSE)

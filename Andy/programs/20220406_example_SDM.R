...
#' Prediction map
#' 
p1 <- predict(m1, newdata = layers_cut, filename='Andy/output/figures/p1.img') 
...
#' 
#' spin this with:
#' ezspin(file = "Andy/programs/20220406_example_SDM.R",out_dir = "Andy/output", fig_dir = "figures",keep_md = FALSE, keep_rmd = FALSE)

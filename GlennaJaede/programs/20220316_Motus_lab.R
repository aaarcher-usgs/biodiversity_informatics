...
#' 
#' 
#' In this program, self guided lab
#' 
#' 
#' ### Header
#' 
...
#' 
#' > Answer: Time zones can be sorted be sorted through different projections.
#' Using different time zones can skew data
#' 
...
#' 
#' spin this with:
#' ezspin(file = "GlennaJaede/programs/20220316_Motus_lab.R",out_dir = "GlennaJaede/output", fig_dir = "figures",keep_md = FALSE, keep_rmd = FALSE)

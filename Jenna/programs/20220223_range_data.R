...
#' Programmer: Jenna
#' 
#' In this program, we struggled. 
#' Then we began working with Genomic ranges. This included creating ranges
#' (using start, end, width, range), plotting ranges, reading the data we 
#' created, merging ranges, and then working with more advanced operations. This 
#' included dealing with buffers, removing buffers, as well as, identifying 
#' overlapping sequences and identifying the gaps. It was fun!
#' 
#' 
#' ### Header
#' 
...
width(x) #individual width of each read

#' What is the total range of the IRanges object?
#' 

range(x) #summary of all reads from start to end
...
x[2:3]
x[c(1,3)] #for rows that are not consecutive
...
#' 
#' spin this with:
#' ezspin(file = "Jenna/programs/20220223_range_data.R",out_dir = "Jenna/output", fig_dir = "figures20220223",keep_md = FALSE, keep_rmd = FALSE)

...
#' Programmer: Mason
#' 
#' In this program, We worked with creating a vector and allowing R to assign names to each value. These values were also inserted into our work based on decending and accending values. In the practice, we worked with even and odd values to assign vectors. Lastly, we worked with a large table to select specific values from depth to select certain rows and columns. 
#' 
#' 
#' ### Header
#' 
...
#' 
#' spin this with:
#' ezspin(file = "MOlinger/programs/20220216_data_in_R.R",out_dir = "MOlinger/output", fig_dir = "figures",keep_md = FALSE, keep_rmd = FALSE)

...
#' Programmer: Mason
#' 
#' In this program, we worked with ggplot and biocmanager to work with tables and plotting.
#' we worked with creating IRanges to choose a range, subtract, and add values from the plot.
#' Lastly we worked with plotting and adding gaps, etc.
#'
#' 
#' 
#' ### Header
...
#' 
#' spin this with:
#' ezspin(file = "MOlinger/programs/20220223_range_data.R",out_dir = "MOlinger/output", fig_dir = "figures20220223",keep_md = FALSE, keep_rmd = FALSE)

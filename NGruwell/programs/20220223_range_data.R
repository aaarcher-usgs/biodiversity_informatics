...
#' February 22, 2022
#' 
#' Programmer: Nicole G and Emma K <3
#' 
#' In this program, we created plot and changed names as well as other factors 
#' within the plot
#' 
#' 
#' ### Header
...
#' but width gives just each inidividual range's width  
...
#' 
#' spin this with:
#' ezspin(file = "NGruwell/programs/20220223_range_data.R",out_dir = "NGruwell/output", fig_dir = "figures20220223",keep_md = FALSE, keep_rmd = FALSE)

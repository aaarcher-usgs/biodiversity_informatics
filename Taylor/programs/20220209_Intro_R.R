...
#' 
#' #### Calculate factorial of 5 using a function

factorial(5)


#' #### Calculate $5^2 + 5^{-1} - \pi$ (Look at the html to see the formula)
...
(x) # sometimes useful way to print results of functions
...
#' 
#' spin this with:
#' ezspin(file = "Taylor/programs/20220209_intro_R.R",out_dir = "Taylor/output", fig_dir = "figures",keep_md = FALSE, keep_rmd = FALSE)

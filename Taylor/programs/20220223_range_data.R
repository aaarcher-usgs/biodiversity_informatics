...
#' 
#' In this program, we explored ranges, in context to working with genomic 
#' data. We explored how to use IRanges to make plots, and we used code to 
#' manipulated range and create plots.
#' 
#' 
#' ### Header
#' 
...
#' 
#' spin this with:
#' ezspin(file = "Taylor/programs/20220223_range_data.R",out_dir = "Taylor/output", fig_dir = "figures20220223",keep_md = FALSE, keep_rmd = FALSE)

...
#' 
#' In this program, I learned how to work with vectors, change the vector type, add names to values, order datasets, look at datasets, and use datasets to make calculations.
#' 
#' 
#' ### Header
#' 
...
colnames(df.ex)[colnames(df.ex)=="X.GC"] <- "pecent.GC"
colnames(df.ex)

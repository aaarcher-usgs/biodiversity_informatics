...
#' 
x # most basic way
print(x, digits = 2) # another way, allows us to change digits directly
...
#' 
#' spin this with:
#' ezspin(file = "savannadroher/programs/20220209_intro_R.R",out_dir = "savannadroher/output", fig_dir = "figures",keep_md = FALSE, keep_rmd = FALSE)

...
#' Programmer: Savanna
#' 
#' In this program, sequenced genomes
#' 
#' 
#' ### Header
#' 
...
#' range summarizes the start and end and width across all the reads/ranges, but 
#' width gives just each individual range's width
...
#' 
#' spin this with:
#' ezspin(file = "savannadroher/programs/20220223_range_data.R",out_dir = "savannadroher/output", fig_dir = "figures20220223",keep_md = FALSE, keep_rmd = FALSE)
